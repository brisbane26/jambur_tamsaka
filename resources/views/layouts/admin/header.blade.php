<header class="flex items-center justify-between px-6 py-4 bg-white border-b-2 border-[#5C1515]">
    <div class="flex items-center">
        ...
        <!-- Search Bar -->
<form method="GET" action="{{ route('paket.index') }}" class="ml-4 hidden lg:block">
    <div class="relative h-10 w-full max-w-md"> <!-- removed mx-4 and added ml-4 -->
        ...
        <input 
            ...
            class="w-full h-10 pl-10 pr-4 rounded-md border border-gray-300 focus:border-indigo-600 focus:ring-indigo-600"
        >
    </div>
</form>
