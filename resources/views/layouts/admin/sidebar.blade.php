...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-[#5C1515] lg:translate-x-0 lg:static lg:inset-0">
    ...
    <nav class="mt-10 flex flex-col gap-0">
        @role('admin')
        <a @click.stop class="flex items-center px-6 py-2 mt-2 rounded transition-colors duration-200
        ...
        @role('customer')
        <a @click.stop class="flex items-center px-6 py-2 mt-2 text-white 
