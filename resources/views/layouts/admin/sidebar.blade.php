...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-[#5C1515] lg:translate-x-0 lg:static lg:inset-0">
    <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
            {{-- Logo di sidebar juga perlu data-turbo --}}
            <a href="{{ route('dashboard') }}" class="flex items-center" data-turbo="true" data-turbo-prefetch="false">
    ...
    <nav class="mt-10 flex flex-col gap-0">
        @role('admin')
           ...
           hover:bg-[#6d3d3d]"
                href="{{ route('dashboard') }}" data-turbo="true" data-turbo-prefetch="false">
           ...
           hover:bg-[#6d3d3d]"
                href="/laporan" data-turbo="true" data-turbo-prefetch="false">
        ...
        @role('admin')
           ...
           hover:bg-[#6d3d3d]"
                href="{{ route('admin.users.index') }}" data-turbo="true" data-turbo-prefetch="false">
        ...
        <a @click.stop
           ...
           hover:bg-[#6d3d3d] transition-colors duration-200 rounded"
            href="{{ route('paket.index') }}" data-turbo="true" data-turbo-prefetch="false">
        ...
        <a @click.stop
           ...
           hover:bg-[#6d3d3d] transition-colors duration-200 rounded"
            href="{{ route('keranjang.index') }}" data-turbo="true" data-turbo-prefetch="false">
        ...
        <a @click.stop
           ...
           hover:bg-[#6d3d3d] transition-colors duration-200 rounded"
            href="{{ route('pesanan.index') }}" data-turbo="true" data-turbo-prefetch="false">
        ...
        <a @click.stop
           ...
           hover:bg-[#6d3d3d] transition-colors duration-200 rounded"
            href="{{ route('pesanan.history') }}" data-turbo="true" data-turbo-prefetch="false">
        ...
        <a @click.stop
           ...
           hover:bg-[#6d3d3d] transition-colors duration-200 rounded"
            href="{{ route('jadwal.index') }}" data-turbo="true" data-turbo-prefetch="false">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        @role('customer')
           ...
           hover:bg-[#6d3d3d] transition-colors duration-200 rounded"
                href="/contact-us" data-turbo="true" data-turbo-prefetch="false">
