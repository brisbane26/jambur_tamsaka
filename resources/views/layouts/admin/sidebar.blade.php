...
@role('customer')
<a class="flex items-center px-6 py-2 mt-4 {{ request()->is('customer/dashboard') ? 'text-gray-100' : 'text-gray-500' }} bg-gray-700 bg-opacity-25" href="{{ route('dashboard') }}">
    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
    </svg>
...
@endrole
        ...
        @role('customer')
        <a class="flex items-center px-6 py-2 mt-4 {{ Route::currentRouteNamed('contact.us') ? 'text-gray-100' : 'text-gray-500' }} hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="/contact-us">
